(() => {
  ...
  const posts = [
    {
      slug: '2025-housing-market-review',
      title: '2025 Housing Market Review: What the Numbers Actually Said',
      date: '2026-01-03',
      category: 'Market Analysis',
      excerpt:
        '2025 was not a housing crash year. It was a year of slow sales, high prices, tighter margins, and a market that became less forgiving for sellers who guessed wrong.',
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=2000&q=70',
      content: [
        '**By Carson Wais, Chris Pachuilo, Connor Gannon, Asnowco**',
        '2025 was not a crash year. It was a grind year.',
        'Existing home sales totaled 4.06 million in 2025, unchanged from 2024 and matching the lowest annual level since 1995. Even with a stronger finish late in the year, transaction volume stayed historically weak. Prices held up better than sales did. The national median existing home price for 2025 reached $414,400, up 1.7% from 2024. That combination defined the year: low activity, still elevated prices, and a market that stayed difficult for both buyers and sellers.',
        'Inventory improved somewhat, but not enough to create a truly loose market. By December 2025, total housing inventory stood at 1.18 million units, up 3.5% from a year earlier, with a 3.3 month supply of homes on the market. That gave buyers more breathing room than they had in the tightest years, but it still was not a fully balanced environment. Sellers had more competition than before, just not a flood of it.',
        'Price growth also lost momentum. Zillow reported in August 2025 that home values had fallen year over year in roughly half of the nation’s largest markets, with sellers cutting prices at record rates to compete. By March 2026, Zillow’s forward view had shifted to just 0.7% expected home value growth by the end of 2026, reflecting a market moving toward balance instead of rapid appreciation. That helps explain 2025 well: the easy upside was fading, and local market selection mattered more than broad national optimism.',
        'Investor margins tightened sharply too. ATTOM’s 2025 year end home flipping report showed 297,045 flips nationwide, down 3.9% from 2024, while the typical flip generated a 25.5% return on investment, down from 32.1% the year before and the lowest level since 2008. Gross profit on the typical flip fell to $65,981 from $77,000 in 2024. That is one of the clearest signs that 2025 became a more disciplined market. Revenue was still there, but the room for mistakes got smaller.',
        'That is the main takeaway from 2025. The market did not fall apart, but it got less forgiving. Sales stayed weak. Prices stayed high. Inventory improved only modestly. Margins compressed. For sellers, that meant timing and property condition mattered more. For investors and wholesalers, it meant tighter underwriting and less room to rely on appreciation to bail out a thin deal. 2025 was the kind of year that rewarded clean math over hopeful assumptions.',
        '## Sources',
        'National Association of Home Builders summary of NAR year end 2025 existing home sales data.\nhttps://www.nahb.org/blog/2026/01/existing-home-sales-climb-to-near-3-year-high-in-december',
        'PBS NewsHour summary of NAR 2025 annual median existing home price data.\nhttps://www.pbs.org/newshour/economy/2025-home-sales-stuck-at-30-year-low',
        'Realtor.com summary of December 2025 inventory and supply data from NAR.\nhttps://www.realtor.com/news/trends/existing-home-sales-nar-december-2025/',
        'Zillow. “Home values are rising in half the country, falling in the other.”\nhttps://investors.zillowgroup.com/investors/news-and-events/news/news-details/2025/Home-values-are-rising-in-half-the-country-falling-in-the-other/default.aspx',
        'Zillow Research. “Home Value and Home Sales Forecast, March 2026.”\nhttps://www.zillow.com/research/home-value-sales-forecast-33822/',
        'ATTOM. “2025 U.S. Home Flipping Report: Profits Lowest Since 2008.”\nhttps://www.attomdata.com/news/market-trends/flipping/2025-year-end-home-flipping-report/'
      ]
    },
    {
    ...
    {
      slug: 'the-math-is-getting-harder-for-sellers-who-wait',
      title: 'The Math Is Getting Harder for Sellers Who Wait',
      date: '2026-03-09',
      category: 'Market Analysis',
      excerpt:
        'Inventory is up, price growth is slowing, and seller margins are tightening. For owners thinking about selling, waiting is no longer a free bet.',
      image: 'https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&w=2000&q=70',
      content: [
        '**By Carson Wais, Asnowco**',
        'The housing market is still holding up nationally, but the easy seller environment is weaker than it used to be. In February 2026, existing home sales were running at a 4.09 million annual pace, inventory reached 1.29 million homes, and supply stood at 3.8 months. Median price was $398,000, up just 0.3% from a year earlier. That is not a crash. It is a slower market with less room for sellers to make timing mistakes.',
        'The price outlook is not giving sellers much help either. Zillow’s March 2026 forecast projected U.S. home values to rise only 0.7% by the end of the year. When appreciation is that weak, waiting six months or a year does not automatically create a better outcome. In a lot of cases, the property carries faster than the value grows.',
        'Inventory is also moving the wrong direction for sellers who want maximum leverage. Zillow reported 1.12 million homes for sale in February, up 5% from a year earlier, while NAR also showed national inventory up 4.9% year over year. More homes on the market usually means more competition, more buyer choice, and less pricing power.',
        'Margins are tightening too. ATTOM’s year end 2025 report showed home seller profit margins fell from 55% in 2024 to 49% in 2025. Sellers are still making money, but the spread is shrinking. That matters because a lot of owners keep thinking in gross price, not net outcome.',
        'That is the real point. In a market where inventory is rising, appreciation is soft, and margins are narrowing, waiting is no longer a free bet. If a property has holding costs, condition issues, vacancy risk, or family pressure behind it, the math can turn against the seller faster than they expect.',
        '## Sources',
        'National Association of Realtors. “Existing-Home Sales Report Shows 1.7% Increase in February.”\nhttps://www.nar.realtor/newsroom/nar-existing-home-sales-report-shows-1-7-increase-in-february',
        'Zillow Research. “Home Value and Home Sales Forecast, March 2026.”\nhttps://www.zillow.com/research/home-value-sales-forecast-33822/',
        'Zillow. “Zillow’s February Market Report Points to Spring Rebound.”\nhttps://www.zillow.com/research/february-2026-market-report-36122/',
        'ATTOM. “Year-End 2025 U.S. Home Sales Report.”\nhttps://www.attomdata.com/news/market-trends/home-sales-prices/2025-year-end-home-sales-report/'
      ]
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?auto=format&fit=crop&w=2000&q=70',
      content: [
...
Automate a single repetitive step: triage, drafting, or summarization. Keep humans in the loop until accuracy is consistent.`,
  ...
  if (preview) {
    ...
    sorted.slice(0, max).forEach((p) => preview.appendChild(card(p)));
  }

  const list = document.querySelector('[data-publications-list]');
  if (list) {
    const sorted = [...posts].sort((a, b) => String(b.date).localeCompare(String(a.date)));
    sorted.forEach((p) => list.appendChild(card(p)));
  }
