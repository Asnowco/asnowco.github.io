  ...
  const posts = [
    {
      ...
      title: 'Clean Timelines in Wholesale Deals',
      date: '2026-03-01',
      category: 'Wholesale Real Estate',
      excerpt: 'A simple framework for keeping deals moving: intake, underwriting, and documentation checkpoints.',
      content: [
        'Speed is useful only when it stays organized. The best wholesale execution is predictable: what happens next, when it happens, and who owns it.',
        '## A simple timeline
...
- Basic property details\n- Stakeholder context\n- Known timeline constraints\n- Preferred communication channel',
    ...
    },
    {
      ...
      date: '2026-03-15',
      category: 'AI and Reputation',
      excerpt: 'Practical AI is about stable workflows. Start small, measure impact, and protect reputation by default.',
      content: [
        'Most AI projects fail because the workflow is unclear. Pick one process, define the input, define the output, and enforce the rules.',
        '## Starting point
